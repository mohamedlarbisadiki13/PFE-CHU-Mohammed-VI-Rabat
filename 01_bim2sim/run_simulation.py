import sys
sys.setrecursionlimit(100000)  # Fait sauter la limite de sécurité de Python pour les IGH
...
def run_example_complex_building_energyplus():
    ...
    # directory
    project_path = Path(r'C:\Users\Administrateur\Documents\PFE_CHU_SADIKI\SIMULATION_ENERGITIQUE\Simulation_BIM2SIM\EP4_F_2')

    # Set the ifc path to use and define which domain the IFC belongs to
    ifc_paths = {
        IFCDomain.arch:
            Path(r'C:\Users\Administrateur\Documents\PFE_CHU_SADIKI\SIMULATION_ENERGITIQUE\IFCs\IFC_VALIDE\I4.ifc')
    }
    ...
    # system requirements
    project.sim_settings.ep_install_path = r'C:\EnergyPlusV9-4-0'
    ...
    project.sim_settings.construction_class_windows = 'Alu- oder Stahlfenster, Waermeschutzverglasung, zweifach'

    # set weather file data
    project.sim_settings.weather_file_path = Path(r'C:\Users\Administrateur\Downloads\MAR_Casablanca.Nouasser.601560_IWEC.epw')
    ...
    project.sim_settings.prj_use_conditions = (Path(
        r"C:\Users\Administrateur\Documents\PFE_CHU_SADIKI\SIMULATION_ENERGITIQUE\Usage_Conditions\UP_Cal_10.json"))
    project.sim_settings.prj_custom_usages = (Path(
        r"C:\Users\Administrateur\Documents\PFE_CHU_SADIKI\SIMULATION_ENERGITIQUE\Custom_Usage\CustomUsage_1.json"))
    ...
    from bim2sim import run_project, ConsoleDecisionHandler  # À ajouter en haut avec les imports
